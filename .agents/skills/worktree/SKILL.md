...
2. Read the methodology guidance that applies to worktree setup and usage.
   - In the methodology source repo, that guidance is [methodology.md](../../../methodology.md) and [docs/worktree-setup.md](../../../docs/worktree-setup.md).
...
- new worktrees and branches following methodology flat naming conventions
...
- the repo's existing layout conflicts with the preferred methodology pattern
