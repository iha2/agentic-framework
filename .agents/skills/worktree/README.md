...
How to use the Worktree skill to set up and manage the required methodology worktree model.

## What It Does

The Worktree skill helps teams work inside the Agentic Engineering Framework methodology's required worktree model.
...
- Worktrees are required by the Agentic Engineering Framework methodology.
...
Use this skill when:
- you are adopting the methodology worktree model in a repo
...
```text
Use worktree.
Please set up this repo with the methodology bare-repo plus sibling-worktree layout.
```
...
- The methodology requires worktrees even when a repo does not use a project board or external tracker for coordination.
