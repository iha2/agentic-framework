...
How to use and adapt the **pr-review** skill for Agentic Engineering Framework methodology pull request review.
...
- Keep human install, setup, troubleshooting, and update checks in `docs/code-review-graph.md` or a copy under the repo's declared docs root when that project doc exists.
- For methodology review, prefer minimal CLI/MCP setup. Do not install upstream companion skills, hooks, or instruction
...
should apply across Agentic Engineering Framework methodology repos.
