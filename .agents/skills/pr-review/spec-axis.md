...
The orchestrator will tell you which spec availability tier applies to this review and provide the spec contents. Agentic Engineering Framework methodology repos typically store deliverable specifications in `<DOCS_ROOT>/specifications/`. Your behavior varies by
tier.
