...
This file is adapted methodology-local workflow guidance, not a vendored upstream skill.
...
Default methodology setup is minimal CLI/MCP access:
...
and troubleshooting details in `docs/code-review-graph.md` or a repo-local copy under the declared docs root when that project doc
exists.
