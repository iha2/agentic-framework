...
The methodology is expected to need a Jira utility skill over time, similar in spirit to other companion utilities that connect agents to an authoritative issue or board system when the repo configures one.
