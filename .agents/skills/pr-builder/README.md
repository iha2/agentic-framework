...
How to use the PR Builder skill to prepare a draft-first pull request title and body for the Agentic Engineering Framework human-in-the-loop
review workflow.
...
- the governing deliverable specification, lightweight bug-fix specification, project board or external tracker record, or tracker item
- test results
...
This is how the skill determines whether the repo is primarily using a deliverable-centric tracker, Jira, Avaza, or another tracking system.
...
The skill may use repo structure to recognize the project's system, but it should not guess authoritative Jira issue keys, deliverable IDs, or Avaza task URLs from weak signals like branch names.
