<!--
  ...
  Or store the specification in a project board or external tracker, or the repo-declared tracking system, when specifications are
...
**Specification storage:** {{ <DOCS_ROOT>/specifications/<slug>.md | project board or external tracker record | external tracker record }}
**Run log:** {{ `<DOCS_ROOT>/execution/<lane-slug>-run-log.md`, project board or external tracker note, external tracker record, or N/A }}
**Execution record sharing:** {{ local ignored file | centralized record on the project board or external tracker | external tracker record }}
