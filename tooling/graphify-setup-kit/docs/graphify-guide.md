# Graphify Guide — global-services

Complete reference for using [Graphify](https://github.com/safishamsi/graphify) with the **global-services** monorepo. Graphify builds a queryable knowledge graph from code (and optionally docs) so AI agents explore the codebase structurally instead of brute-forcing grep and full-file reads.

**Related docs:**

- [graphify-new-computer-setup.md](./graphify-new-computer-setup.md) — **start here** for new computer + new user (install, HTML, stats)
- [graphify-setup-kit/README.md](./graphify-setup-kit/README.md) — portable package + `install.sh` / `install.ps1`
- [graphify-agent-setup-prompt.md](./graphify-agent-setup-prompt.md) — copy-paste agent prompt
...
1. **Install** — [graphify-new-computer-setup.md](./graphify-new-computer-setup.md) Part 3 (setup kit)
...
**Design choice:** Graphify artifacts are **gitignored**. Each developer builds their own graph locally. Only `docs/misc/graphify-local.md` in the repo mentions Graphify (minimal pointer). Full docs and the setup kit live under `~/Documents/Projects/`.
...
└── docs/                               # This guide + setup docs + agent prompt
```
...
See [graphify-setup-kit/MANIFEST.md](./graphify-setup-kit/MANIFEST.md) for required vs optional files.
...
| Path | Purpose |
|---|---|
| `~/Documents/Projects/graphify-setup-kit/` | Portable install package + `install.sh` |
| `~/Documents/Projects/graphify-guide.md` | This document |
| `~/Documents/Projects/graphify-new-computer-setup.md` | New machine setup |
| `~/Documents/Projects/graphify-agent-setup-prompt.md` | Agent prompt |
...
**Recommended:** [graphify-setup-kit](./graphify-setup-kit/README.md) — `./install.sh --optional --build --verify ../global-services`

**Manual:** [graphify-new-computer-setup.md](./graphify-new-computer-setup.md)
...
All report outputs are **local and gitignored**. See [graphify-new-computer-setup.md § Part 6](./graphify-new-computer-setup.md#part-6--reports-statistics--html-complete-guide) for the full new-user walkthrough.
...
| New team member | Run [graphify-setup-kit/install.sh](./graphify-setup-kit/README.md) or follow [graphify-new-computer-setup.md](./graphify-new-computer-setup.md) |
...
- Setup kit: [graphify-setup-kit/](./graphify-setup-kit/README.md)
- Jira story: SKUNK-438 (Graphify multi-machine setup documentation)
- New machine setup: [graphify-new-computer-setup.md](./graphify-new-computer-setup.md)
- Agent prompt: [graphify-agent-setup-prompt.md](./graphify-agent-setup-prompt.md)
