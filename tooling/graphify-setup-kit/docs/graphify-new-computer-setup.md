...
Complete onboarding for a **new machine** and **new team member** using Graphify with the **global-services** monorepo. Covers install, daily use, reports, HTML visualizations, and token statistics.

**Companion docs:**

| Doc | When to use |
|---|---|
| [graphify-guide.md](./graphify-guide.md) | Full reference — querying, troubleshooting, CLI |
| [graphify-setup-kit/README.md](./graphify-setup-kit/README.md) | Portable install package (`install.sh` / `install.ps1`) |
| [graphify-agent-setup-prompt.md](./graphify-agent-setup-prompt.md) | Let a Cursor agent run setup for you |
...
| **Setup kit** | `~/Documents/Projects/graphify-setup-kit/` | `%USERPROFILE%\Documents\Projects\graphify-setup-kit\` |
...
Copy the entire folder to the new machine (USB, zip, scp, shared drive):

```
~/Documents/Projects/graphify-setup-kit/     # macOS/Linux
%USERPROFILE%\Documents\Projects\graphify-setup-kit\   # Windows
```
...
See [graphify-guide.md](./graphify-guide.md) or copy `.graphifyignore` + `.cursor/rules/graphify.mdc` via scp from a teammate, then:
...
- [graphify-guide.md](./graphify-guide.md) — complete reference
- [graphify-setup-kit/README.md](./graphify-setup-kit/README.md) — install scripts
- [graphify-agent-setup-prompt.md](./graphify-agent-setup-prompt.md) — agent-driven setup
- `global-services/docs/misc/graphify-local.md` — in-repo pointer
