...
| Companion board/tracker integration (repo-configured) | Synchronizes feature-linked deliverables and execution state when the repo uses a project board or external tracker for work items. |
