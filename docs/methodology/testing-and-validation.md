...
| Companion board/tracker integration (repo-configured) | Records QA findings, task state, and validation notes when the repo uses a project board or external tracker for work items. |
