...
| Companion board/tracker integration (repo-configured) | Creates or synchronizes board-backed deliverables and specification paths when the repo uses a project board or external tracker for work items. |
