...
| Companion board/tracker integration (repo-configured) | Updates task state, locks, notes, and execution metadata when the repo uses a project board or external tracker for work items. |
